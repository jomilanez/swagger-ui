...
(function() {
  var OAuthorization, ApiKeyAuthorization, PasswordAuthorization, SwaggerApi, SwaggerAuthorizations, SwaggerHttp, SwaggerModel, SwaggerModelProperty, SwaggerOperation, SwaggerRequest, SwaggerResource,
  ...
  SwaggerOperation = (function() {
    function SwaggerOperation(nickname, path, method, parameters, summary, notes, type, responseMessages, resource, consumes, produces) {
      ...
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        ...
        type = parameter.type || parameter.dataType || parameter.items.type || parameter.items["$ref"];
  ...
  OAuthorization = (function(obj) {

    OAuthorization.prototype.key = null;
    OAuthorization.prototype.password = null;
    OAuthorization.prototype.method = null;

    function OAuthorization(key, password, method) {
      this.key = key;
      this.password = password;
      this.method = method;
    }

      OAuthorization.prototype.apply = function(obj) {
        var consumer = new Object();
        consumer.public = this.key;
        consumer.secret = this.password;
        var parameter = new Object();
        parameter.consumer = consumer;
        parameter.signature_method = this.method;
        var oauth = new OAuth(parameter);
        obj.headers["Authorization"] = oauth.toHeader(oauth.authorize(obj, "")).Authorization;
